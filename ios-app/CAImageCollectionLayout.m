...
static NSString * const PortfolioLayoutCellKind = @"ConnectCell";
...
- (void)setup
{
    self.itemInsets = UIEdgeInsetsMake(20.0f, 20.0f, 9.0f, 20.0f);
    self.itemSize = CGSizeMake(125.0f, 125.0f);
    self.interItemSpacingY = 9.0f;
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[PortfolioLayoutCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[PortfolioLayoutCellKind][indexPath];
}
